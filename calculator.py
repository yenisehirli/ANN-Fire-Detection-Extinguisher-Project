...
client_ip = '192.168.1.16'  # Raspberry Pi'nizin IP adresini buraya yazın
client_port = 5001
...
while True:
    ...
    currentAngle = angle(height, width, 10, 5, currentAngle, im)

    cv2.imshow('Received Frame', im)

    nesne_bytes = pickle.dumps(currentAngle)
